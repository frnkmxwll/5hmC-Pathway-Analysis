...
cutoff_type = 4 # 0=padj cutoff, default; 1=lfc & pvalue cutoff; 2 = no cutoff (genome wide); 3=gene list; 4=previously run sig list;
...
ver <- "training_genomewide_0p01_lfc0p13"
...
design_formula <- ~ sex + age + race + batch + condition 
...
#test_prob = predict(mylogit, type = "response")
test_prob = predict(mylogit, predictors_training, type = "response")
...
png(paste("./Output/DESeq2/logit/",contrast_groups[2],contrast_groups[3],"_",ver,"/",contrast_groups[2],contrast_groups[3],ver,"validation_0p025",".png",sep=""), width = 900, height = 1200)
...
png(paste("./Output/DESeq2/logit/",contrast_groups[2],contrast_groups[3],"_",ver,"/",contrast_groups[2],contrast_groups[3],ver,"training_0p025",".png",sep=""), width = 900, height = 1200)
#pheatmap(log_counts_data,
#         main = heatmap_title,
